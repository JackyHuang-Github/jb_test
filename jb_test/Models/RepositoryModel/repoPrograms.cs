...
";
    ...
    {
        return repo.ReadSingle(m => m.PrgNo == prgNo);
    }
    /// <summary>
    /// 取得模組編號
    /// </summary>
    /// <param name="prgNo">程式編號</param>
    /// <returns></returns>
    public string GetModuleNo(string prgNo)
    {
        string str_value = "";
        var data = repo.ReadSingle(m => m.PrgNo == prgNo);
    ...
    /// <returns></returns>
    public List<Programs> GetPrgList(string moduleNo)
    {
